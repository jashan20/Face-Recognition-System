...
skip = 0
# FACE DATA FOR TRAINING MODEL
face_data = []
# Path for face data in Data Folder
dataset_path = './data/'
...
while True:
    ...
    # sort the faces according to the area of image f[2] = width,f[3] = height
	...
	for face in faces[-1:]:
		...
		skip += 1
        #Now we store every 10th image of face
		if skip%10==0:
    ...
    # To stop the camera by pressing q
    # waitkey(1) & 0xFF it convert 32 bit number to 8 bit number as 0xff is 11111111
